...
SCHEMA_PATH = Path('/Users/sindre/Documents/minkode/Programmering Med KI/Prosjektoppgave/SG-Driftige/fastapi-backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin': '/Users/sindre/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    content: 'actions.ContentActions[models.Content]'
    ...
    def __init__(
        ...
        *,
        ...
        self.content = actions.ContentActions[models.Content](self, models.Content)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/sindre/Documents/minkode/Programmering Med KI/Prosjektoppgave/SG-Driftige/fastapi-backend/prisma/schema.prisma',
        }
...
class Batch:
    content: 'ContentBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.content = ContentBatchActions(self)
